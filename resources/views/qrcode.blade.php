...
<tbody>
<tr>
<td style="color:#333333;padding-top: 20px;padding-bottom: 3px;"><strong>Sent from Team:</strong></td>
</tr>
<tr>
<td style="color:#555555;padding-top: 3px;padding-bottom: 20px;">{{$team_name}}</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="color:#333333;padding-top: 20px;padding-bottom: 3px;"><strong>Your Virtual Ticket</strong>
<p><strong>Valid from: {{$valid_from}}</strong></p>
<p><strong>Valid to: {{$valid_to}}</strong></p>
