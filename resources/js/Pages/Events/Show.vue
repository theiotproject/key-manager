                                    ...
                                    <table class="w-full text-sm text-left text-gray-500">
                                        ...
                                        >
                                            ...
                                            <td
                                                class="px-2 py-4 font-medium whitespace-nowrap"
                                            >
                                                <span v-if="scanAttempt[0].name.length<8">{{ scanAttempt[0].name }}</span>
                                                <span v-else>{{ scanAttempt[0].name.substring(0,20)+".." }}</span>
                                            </td>
                                            <td
                                                class="px-2 py-4 font-medium whitespace-nowrap"
                                            >
...
.area-2-1 { grid-area: 1 / 1 / 2 / 4; }
.area-2-2 { grid-area: 1 / 4 / 2 / 6; }
</style>
